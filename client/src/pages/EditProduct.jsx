    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input type="text" name="name" value={form.name} onChange={handleChange} className={`input-field ${errors.name ? "border-red-400" : ""}`} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select name="category" value={form.category} onChange={handleChange} className={`input-field ${errors.category ? "border-red-400" : ""}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-end pb-2.5">
            <label className="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" name="featured" checked={form.featured} onChange={handleChange} className="w-4 h-4 rounded text-primary-600" />
        ...
        <div className="flex gap-3 pt-4">
          ...
          <Link to={`/products/${id}`} className="btn-secondary">Cancel</Link>
        </div>
      </form>
    </div>
  );
